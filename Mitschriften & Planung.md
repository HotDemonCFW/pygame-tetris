...
**main.py erstellen und aufbauen:**
Zuerst müssen wir wissen, was das Haupt spiel, aus macht, welche Bibliotheken wir dafür benötigen und ganz wichtig ist keine fremden Grafiken wie z.B. Bilder, Bitmaps oder der gleichen zu verwenden diese soll nämlich durch den pygame-code erstellt werden. Also kommen wir zu dem spiel es soll in ein quadratisches 10x20 Grid-Pattern gespielt werden bei dem zufällig unterschiedliche Formen aus einem 4x4 Matrizen-Raster kommen, die dann von oben nach unten fallen, diese Formen kann man mit der angegebenen Steuerung bewegen sollte eine Zeile gefüllt werden so wird diese zerstört und man bekommt, punkte dafür. Rechts soll ein Info-Panel stehen dort sollen aufgelistet sein: Punkte, zerstörte reihen, nächste Form und die Steuerung. Sobald nur eine Form die oberste Reihe berührt, so ist man "Game-Over" danach kann man, sofern man will seinen Namen eintragen und wird in der Highscore-Liste mit aufgeführt und startet das spiel neu.